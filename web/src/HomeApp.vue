...
const quickTools = [
  { title: "商品主图", desc: "快速进入 AI 商品图创作", href: "/workspace", badge: "AI", icon: ImageIcon },
  { title: "商品场景图", desc: "参考商品图生成营销场景", href: "/workspace", badge: "AI", icon: WandSparkles },
  { title: "批量商品图", desc: "多 SKU 批量生成与任务管理", href: "/batch", badge: "HOT", icon: Layers3 },
  { title: "AI 优化提示词", desc: "优化电商视觉生成指令", href: "/workspace", badge: "AI", icon: Sparkles },
  { title: "ROI 计算器", desc: "广告投入与回报快速测算", href: "/tools", badge: "规划中", icon: TrendingUp },
  { title: "毛利计算器", desc: "售价、成本与费用结构测算", href: "/tools", badge: "规划中", icon: BadgeDollarSign }
] as const;
...
<template>
  <div class="v15-home v1501-home v1503-home">
    ...
    <main>
          ...
          <div class="v15-board-window">
            ...
            <div class="v15-board-body">
              <aside>
                ...
                <i class="active"><ImageIcon :size="16" /></i>
                <i><Layers3 :size="16" /></i>
                <i><Calculator :size="16" /></i>
                <i><Wrench :size="16" /></i>
              </aside>
              <section>
      ...
      <section class="v15-home-section v15-capability-section">
        ...
        <div class="v15-capability-grid">
          ...
          >
            <span class="v15-capability-mark">
    ...
    <footer class="v15-home-footer">
      <div class="v15-home-footer-inner">
        <div class="v15-footer-brand">
          <strong>ZHE AI</strong>
          <span>AI 电商视觉与运营工作平台</span>
          <small>© 2026 ZHE AI</small>
        </div>

        <nav class="v15-footer-product" aria-label="产品导航">
        ...
        <nav class="v15-footer-legal" aria-label="规则与支持">
          <a href="/terms">用户协议</a>
