...
type ProviderKind = "generic" | "builtin";
type EditorTab = "connection" | "protocol" | "models" | "test";
...
const KATU_SIZE_MAPS: Record<string, Record<string, string>> = {
  "1K": {
    "1:1": "1024x1024",
    "16:9": "1536x864",
    "9:16": "864x1536",
...
const GRSAI_VIP_SIZE_MAPS: Record<string, Record<string, string>> = {
  "1K": {
    "1:1": "1024x1024",
    "16:9": "1280x720",
    "9:16": "720x1280",
